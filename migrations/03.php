...
class UpdateStoreOrderIntraCity extends Migrator
{
    ...
    public function change()
    {
        ...
        $table->addColumn(Column::text('user_address_object')->setComment('收货用户地址对象')->setNull(true))
            ...
            ->addColumn('wechat_store_id', AdapterInterface::PHINX_TYPE_STRING, ['comment' => '同城配送门店编号', 'null' => false, 'limit' => 50, 'default' => ''])
            ...
            ->addColumn('wechat_order_id', AdapterInterface::PHINX_TYPE_STRING, ['comment' => '同城配送订单编号', 'null' => false, 'limit' => 50, 'default' => ''])
            ...
            ->addIndex('wechat_store_id')
            ->addIndex('wechat_order_id')
